package me.jtx.flopac.util.command;
...
public class CommandUtils {
    ...
    public static void registerCommand(me.jtx.flopac.base.command.Command commandObject) {
        try {
    ...
    public static void unRegisterBukkitCommand(me.jtx.flopac.base.command.Command commandObject) {
        try {
